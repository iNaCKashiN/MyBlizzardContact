 ...
 * --
 * <p/>
 * This class represent an activity for setting the contact profile.
 */
public class ContactSettingActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_save) {
            ...
            // Save DataBase
            this.application.UpdateFriend(currentFriend);
    ...
    private void setupEvent() {
        ...
        takeNewPhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent photoActivity = new Intent(ContactSettingActivity.this, PhotoActivity.class);
